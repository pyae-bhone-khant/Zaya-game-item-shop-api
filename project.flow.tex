...
Security: Admin Dashboard ကို Role အပေါ်မူတည်ပြီး ကာကွယ်ထားဖို့ (Middleware သုံးဖို့)
 ...
 "scripts": {
  "test": "jest",
  "dev": "npm-run-all --parallel dev:node work cache",
  "dev:node": "nodemon --exec tsx src/index.ts",
  "work": "nodemon --exec tsx src/jobs/workers/imageWorker.ts",
  "cache": "nodemon --exec tsx src/jobs/workers/cacheWorker.ts",
  "build": "tsc --build", 
